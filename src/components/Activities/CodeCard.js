...
const ASSETS_BASE_URL = process.env.REACT_APP_DISCORD_APP_ASSETS_BASE_URL;
    ...
    <div className="flex mx-2 transition-all duration-100 flex-row justify-center items-center">
      <div className="relative">
        <img
          ...
          src={`${ASSETS_BASE_URL}/${presenceData.application_id}/${presenceData.assets.large_image}.png`}
          alt=""
        />
        <img
          ...
          src={`${ASSETS_BASE_URL}/${presenceData.application_id}/${presenceData.assets.small_image}.png`}
          alt=""
        />
      </div>
